...
void pn_calculation(int i)
{
    ...
    double nv    = (nvec[0] * v[0] + nvec[1] * v[1] + nvec[2] * v[2]);
    double nvdot = (ndot[0] * v[0] + ndot[1] * v[1] + ndot[2] * v[2]) +
                   (nvec[0] * (at1[0] - at2[0]) +
                    nvec[1] * (at1[1] - at2[1]) +
                    nvec[2] * (at1[2] - at2[2]));
    ...
    for (int k = 0; k < 3; k++)
    {
        ...
        pn25d[k] = ndot[k] * ((208./15. * mpbh2 - 24./5. * mp2bh) * nv * r4inv +   \
                   12./5. * mpbh * r3inv * nv * v1_v22) + nvec[k] * (-4. * r5inv   \
                   * rp * nv * (208./15. * mpbh2 - 24./5. * mp2bh) + nvdot *       \
                   r4inv * (208./15. * mpbh2 - 24./5. * mp2bh) - 36./5. * mpbh *   \
                   r4inv * rp * nv * v1_v22 + 12./5. * mpbh * r3inv * (nvdot *     \
                   v1_v22 + nv * v12a)) + (at1[k] - at2[k]) * (mpbh * r4inv *      \
