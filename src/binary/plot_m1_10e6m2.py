...
files = []
files.append('m1_10e6m2_pec1_2000t_e0p2')
files.append('m1_10e6m2_pec2_2000t_e0p2')
files.append('m1_10e6m2_pec3_2000t_e0p2')
files.append('m1_10e6m2_pec4_2000t_e0p2')

files.append('m1_10e6m2_pec1_2000t_e0p9')
files.append('m1_10e6m2_pec2_2000t_e0p9')
files.append('m1_10e6m2_pec3_2000t_e0p9')
files.append('m1_10e6m2_pec4_2000t_e0p9')

files.append('m1_10e6m2_pec1_2000t_e0p99')
files.append('m1_10e6m2_pec2_2000t_e0p99')
files.append('m1_10e6m2_pec3_2000t_e0p99')
files.append('m1_10e6m2_pec4_2000t_e0p99')
...
ax2.text(200, 1e-3, r'$e_{0} = 0.9$', color='black', fontsize=12,
        bbox=dict(facecolor='none', edgecolor='black', boxstyle='round,pad=0.8'))
ax2.text(550, 1e-8, r'$n = 2,3,4$', fontsize=14)
ax2.text(550, 2e-5, r'$n = 1$',     fontsize=14)
...
ax1.set_title(r'$P(EC)^n$ ($a = 1$, $T = 2\pi$, $q=1/10^{6}$)', fontsize=20)
ax3.set_xlabel(r'$T(\Omega_{0})^{-1}$', fontsize=20)
ax1.grid(True)
ax2.grid(True)
ax3.grid(True)
fig.savefig('m1_10e6m2.pdf', format='pdf')
#fig.show()
