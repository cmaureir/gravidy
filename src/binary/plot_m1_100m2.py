...
files = []
files.append('m1_100m2_pec1_2000t_e0p2')
files.append('m1_100m2_pec2_2000t_e0p2')
files.append('m1_100m2_pec3_2000t_e0p2')
files.append('m1_100m2_pec4_2000t_e0p2')

files.append('m1_100m2_pec1_2000t_e0p9')
files.append('m1_100m2_pec2_2000t_e0p9')
files.append('m1_100m2_pec3_2000t_e0p9')
files.append('m1_100m2_pec4_2000t_e0p9')

files.append('m1_100m2_pec1_2000t_e0p99')
files.append('m1_100m2_pec2_2000t_e0p99')
files.append('m1_100m2_pec3_2000t_e0p99')
files.append('m1_100m2_pec4_2000t_e0p99')
...
ax1.set_title(r'$P(EC)^n$ ($a = 1$, $T = 2\pi$, $q=1/100$)', fontsize=20)
ax3.set_xlabel(r'$T(\Omega_{0})^{-1}$', fontsize=20)
ax1.grid(True)
ax2.grid(True)
ax3.grid(True)
fig.savefig('m1_100m2.pdf', format='pdf')
#fig.show()
