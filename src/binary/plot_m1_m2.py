...
ax2.text(100, 1e-9, r'$e_{0} = 0.9$', color='black', fontsize=12,
        bbox=dict(facecolor='none', edgecolor='black', boxstyle='round,pad=0.8'))
ax2.text(530, 2e-10, r'$n = 2,3,4$', fontsize=14)
...
ax1.set_title(r'$P(EC)^n$ ($a = 1$, $T = 2\pi$, $q=1$)', fontsize=20)
ax3.set_xlabel(r'$T(\Omega_{0})^{-1}$', fontsize=20)
ax1.grid(True)
ax2.grid(True)
ax3.grid(True)
fig.savefig('m1_m2.pdf', format='pdf')
#fig.show()
