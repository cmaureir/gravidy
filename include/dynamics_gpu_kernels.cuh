...
__global__ void k_update_2d            (int*,     double4*, double4*, double4*,
...
__global__ void k_update_acc_jrk_single(double4*, double4*, double4*, double4*,
                                        float*,   int,  int);
__global__ void k_predicted_pos_vel    (double4*, double4*, double4*, double4*,
                                        double4*, double4*, double*,  double, int);
